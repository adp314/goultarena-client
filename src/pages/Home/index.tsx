    ...
    <GlobalLayout
      pageContainer={
        <div className=" w-full h-full">
          ...
          <div className="bg-[#1C1917] text-white font-KoHo flex flex-col justify-between">
            <p className=" text-4xl px-24 py-8">
              ...
              metus aliquet in. Donec tincidunt in turpis eget pulvinar. Nullam
              tellus arcu, imperdiet tempor mollis sed, venenatis ut quam.
              Praesent quis lacus sapien. Nullam euismod eleifend sem sed
              hendrerit. Fusce luctus suscipit quam et pellentesque. Donec
              hendrerit. Fusce luctus suscipit quam et pellentesque. Donec
              iaculis imperdiet lectus, nec sagittis metus aliquet in. Donec
              tincidunt tortor mauri tortor mauris suscipit nisi, eu mollis arcu
              nulla a enim. Aliquam Lorem ipsum dolor sit amet, consectetur
